...
public class Update {
	public static final Vector2 ORIGIN = new Vector2(Controller.Size/2,10);
	public static final int DEFAULT_DISTANCE = 1000/5; //70cm stick + 30cm
	public static final double SENSOR_WIDTH = 21.3/5;
	public static final int ORIGIN_RADIUS = 500/5; //10cm
	public static final int MAX_RADIUS = 1000/5;
	public static final double COVERAGE = 360/5; //Human Width
